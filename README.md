...
**FlexScreener** est un outil de prospection B2B conçu pour l'équipe Growth/Business Development de **Tilt Energy**. Il permet d'identifier instantanément le potentiel d'effacement électrique (CVC) des bâtiments tertiaires sur une zone géographique donnée.
